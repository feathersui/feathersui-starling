...
This error usually pops up when we try to ask a component in our application to use a different [text renderer](../text-renderer.html) (or a different [text editor](../text-editor.html)) than the [theme](../theme.html) expects. You either need to remove the component's style provider or [extend the theme](../extending-themes.html). Please see [this detailed explanation](cannot-create-property-element-format.html) for more information.
