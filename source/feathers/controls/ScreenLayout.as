...
package feathers.controls {
     ...
     */
    public class ScreenLayout extends ScrollContainer implements IScreen {
        ...
        public function ScreenLayout() {
            this.addEventListener(Event.ADDED_TO_STAGE, screenAnchor_addedToStageHandler);
            super();
         ...
         * @private
         */
        protected function screenAnchor_addedToStageHandler(event:Event):void
        {
            if(event.target != this)
            {
                return;
            }
            this.addEventListener(Event.REMOVED_FROM_STAGE, screenAnchor_removedFromStageHandler);
            //using priority here is a hack so that objects higher up in the
            //display list have a chance to cancel the event first.
            var priority:int = -getDisplayObjectDepthFromStage(this);
            Starling.current.nativeStage.addEventListener(KeyboardEvent.KEY_DOWN, screenAnchor_nativeStage_keyDownHandler, false, priority, true);
        }

        /**
         * @private
         */
        protected function screenAnchor_removedFromStageHandler(event:Event):void
        {
            if(event.target != this)
            {
                return;
            }
            this.removeEventListener(Event.REMOVED_FROM_STAGE, screenAnchor_removedFromStageHandler);
            Starling.current.nativeStage.removeEventListener(KeyboardEvent.KEY_DOWN, screenAnchor_nativeStage_keyDownHandler);
        }

        /**
         * @private
         */
        protected function screenAnchor_nativeStage_keyDownHandler(event:KeyboardEvent):void
        {
