...
package feathers.controls
{
	...
	public class ScrollScreen extends ScrollContainer implements IScreen
	{
		...
		protected function scrollScreen_addedToStageHandler(event:Event):void
		{
			...
			starling.nativeStage.addEventListener(KeyboardEvent.KEY_DOWN, scrollScreen_nativeStage_keyDownHandler, false, priority, true);
		}
		...
		protected function scrollScreen_removedFromStageHandler(event:Event):void
		{
			...
			var starling:Starling = stageToStarling(this.stage);
			starling.nativeStage.removeEventListener(KeyboardEvent.KEY_DOWN, scrollScreen_nativeStage_keyDownHandler);
		}
